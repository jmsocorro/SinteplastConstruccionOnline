...
const Pedido = ({ pedido }) => {
    ...
    if (typeof pedido.estado !== "undefined") {
        ...
        return (
            <Container className={`pedido estado${pedido.estado}`}>
                <div className="border my-4 p-4">
                    ...
                    <Row className="mt-4">
                        <Col lg={12} className="fs-4 fw-bold">
                            Datos del comprador
                        </Col>
                        <Col
                            lg={4}
                            className="datos nombre"
                            data-titulo="Nombre y Apellido"
                        >
                            {pedido.datosPedido.nombre}{" "}
                            {pedido.datosPedido.apellido}
                        </Col>
                        <Col
                            lg={4}
                            className="datos celular"
                            data-titulo="Celular"
                        >
                            {pedido.datosPedido.ddi} {pedido.datosPedido.cca}{" "}
                            {pedido.datosPedido.cnum}
                        </Col>
                        <Col
                            lg={4}
                            className="datos email"
                            data-titulo="Correo electrónico"
                        >
                    ...
                    <Row className="mt-4">
                        ...
                        <Col
                            lg={6}
                            className="datos direccion"
                            data-titulo="Calle"
                        >
                            {pedido.datosPedido.calle}{" "}
                            {pedido.datosPedido.calleNum}{" "}
                            {pedido.datosPedido.piso}
                        </Col>
                        <Col
                            lg={6}
                            className="datos celular"
                        ...
                        >
                            {pedido.datosPedido.localidad} [
                            {pedido.datosPedido.cp}]{" "}
                            {pedido.datosPedido.provincia}
                        </Col>
                    </Row>
                </div>
            ...
            <Container>
                <Row className="pt-4">
                    ...
                    <Col sm={12} className="d-flex justify-content-center pt-2 fs-3">
                        <div>EL pedido que buscas no existe</div>
                    </Col>
                </Row>
            </Container>
        );
